...
## Date:22.05.2025
```
REGISTRATION NUMBER: 212224230295
```
## AIM:
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <footer class="bg-dark text-white py-3">
        <div class="container text-center">
            <p class="mb-0">Designed and developed by VASANTH P(212224230295)</p>
        </div>
    </footer>
...
## OUTPUT:
![image](https://github.com/user-attachments/assets/23e7158d-78bd-435e-ae80-efed333c936a)
![image](https://github.com/user-attachments/assets/1ffa4a8d-1942-4f39-aca3-2141c0f20af4)
